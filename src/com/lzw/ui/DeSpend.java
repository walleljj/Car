 ...
 * @author 绘梦
 */
public class DeSpend extends javax.swing.JFrame {

    /**
     * Creates new form DeSpend
     */
    public DeSpend() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("*事故车牌：");
        jLabel2.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);

        jLabel3.setFont(new java.awt.Font("宋体", 0, 18)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel3.setText("*处理花费：");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        int jjj = Integer.parseInt(jTextField8.getText());
        ...
        UseCard uc = ucd.findById(jjj);
         Date date2 = null;
        //uc.setEndTime(date2.valueOf("2018-1-11"));
        uc.setNotes("事故");
        ucd.update(uc);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeSpend.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
