 ...
 * @author 绘梦
 */
public class AddUse extends javax.swing.JFrame {

    /**
     * Creates new form AddUse
     */
    public AddUse() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String head = jTextField5.getText();
        String driver = jTextField8.getText();
        String notes = jTextPane1.getText();
        Date dt = null;
        UseCard uc = new UseCard(id,dId,cId,dt.valueOf(bt),dt.valueOf(tt),head,driver,notes);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddUse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
